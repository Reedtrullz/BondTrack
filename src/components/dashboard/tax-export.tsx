    ...
    try {
      ...
      const rows = positions.map((pos: LpPosition) => {
        ...
        return [
          ...
          depositDate,
          withdrawalDate,
          formatRuneAmount(pos.runeDeposit),
          formatAmount(pos.asset2Deposit, pos.assetSymbol),
          formatRuneAmount(pos.runeWithdrawn),
          formatAmount(pos.asset2Withdrawn, pos.assetSymbol),
          formatUsd(entryValue),
