    ...
    <tr className="border-b border-zinc-100 hover:bg-zinc-50 transition-colors">
      <td className="py-4 px-4">
        <div className="flex flex-col">
          <span className="font-medium text-zinc-900">{position.pool}</span>
          <span className="text-xs text-zinc-500">{position.address.slice(0, 6)}...{position.address.slice(-4)}</span>
        </div>
      </td>
      <td className="py-4 px-4">
      ...
      <td className="py-4 px-4">
        <div className="w-full bg-zinc-200 rounded-full h-2 max-w-[100px]">
          <div
        ...
        <span className="text-xs text-zinc-500">{position.healthScore}/100</span>
      </td>
