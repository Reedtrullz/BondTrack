  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md border border-zinc-200">
      <div className="flex justify-between items-start mb-4">
        <div>
          <p className="text-sm text-zinc-500 font-medium uppercase tracking-wide">Pool</p>
          <p className="text-lg font-bold text-zinc-900">{position.pool}</p>
        </div>
        <LpStatusBadge status={position.status} />
      </div>
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4 lg:grid-cols-4">
        <div>
          <p className="text-sm text-zinc-500">Bonded RUNE</p>
